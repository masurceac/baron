/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: a813f3fcd8a1fd2cc16ef683c7d179f4)
// Runtime types generated with workerd@1.20250523.0 2024-12-30 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NODE_VERSION: "22.11.0";
		NEXTJS_ENV: string;
		NEXT_PUBLIC_LIVE_TRADE_WS_URL: string;
		...
		PISI_KEY: string;
		PISI_SECRET: string;
		WORKER_SELF_REFERENCE: Fetcher /* pfm-website */;
		ASSETS: Fetcher;
	}
}
