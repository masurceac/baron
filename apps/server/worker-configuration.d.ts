/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bc81fd048c6bf049997fa7718b27de9f)
...
declare namespace Cloudflare {
	interface Env {
		...
		GROK_API_KEY: string;
		SELF_TRAINING_ROOM: Workflow;
		SIMULATION_ITERATION_WORKFLOW: Workflow;
		ORDER_PLACEMENT_WORKFLOW: Workflow;
		ORDER_PLACEMENT_TRIGGER: Workflow;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "DEEPSEEK_API_KEY_ID" | "DATABASE_CONNECTION_STRING" | "OPENAI_API_KEY" | "ENV" | "GOOGLE_GEMINI_API_KEY" | "GROK_API_KEY">> {}
}
