        ...
        <CardContent>
          <ItemForm
            defaultValues={{
              ...
              selfTrainingPrompt:
                'Identify the gaps in the original prompt that led to failed orders. Use given reasons the understand what caused the AI to enter that trades. Update original prompt so that it prevents failed orders, but also maximize the revenue of positive orders. Avoid making the new prompt too restrictive, so that the AI can still find new opportunities.',
