        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            {profiles.fields.map((profile, profileIndex) => (
              <div key={profile.id} className="space-y-4 p-4 border rounded-lg">
                <div className="flex items-center justify-between">
                  <h4 className="font-medium">Profile {profileIndex + 1}</h4>
                  <Button
                    type="button"
                    variant="ghost"
                    size="sm"
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        const zones =
                          form.getValues(`profiles.${profileIndex}.zones`) ||
                          [];
