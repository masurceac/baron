...
--> statement-breakpoint
CREATE TABLE "simulation_room_to_volume_profile_config" (
	"id" text PRIMARY KEY NOT NULL,
	"simulation_room_id" text NOT NULL,
	"volume_profile_config_id" text NOT NULL
);
...
CREATE TABLE "zone_volume_profile" (
	...
	"zone_start_at" timestamp with time zone NOT NULL,
	"zone_end_at" timestamp with time zone NOT NULL,
...
ALTER TABLE "simulation_room_to_informative_bar" ADD CONSTRAINT "simulation_room_to_informative_bar_informative_bar_config_id_informative_bar_config_id_fk" FOREIGN KEY ("informative_bar_config_id") REFERENCES "public"."informative_bar_config"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "simulation_room_to_volume_profile_config" ADD CONSTRAINT "simulation_room_to_volume_profile_config_simulation_room_id_simulation_room_id_fk" FOREIGN KEY ("simulation_room_id") REFERENCES "public"."simulation_room"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "simulation_room_to_volume_profile_config" ADD CONSTRAINT "simulation_room_to_volume_profile_config_volume_profile_config_id_volume_profile_config_id_fk" FOREIGN KEY ("volume_profile_config_id") REFERENCES "public"."volume_profile_config"("id") ON DELETE cascade ON UPDATE cascade;